...
<label class="text-ellipsis" for="{key}-option">{normalCase(key)}:</label>
<select
...
<style lang="postcss">
	.settings-selection {
		@apply box-content w-28 px-2 h-7 relative mx-auto rounded-lg bg-surface-50 border-2 border-surface-400 outline-none focus:border-tertiary-200;
	}
