...
<label class="text-ellipsis" for="{key}-number">{normalCase(key)}:</label>
<input
...
<style lang="postcss">
	.settings-number {
		@apply appearance-none box-content w-28 px-2 h-7 relative mx-auto rounded-lg bg-surface-50 border-2 border-surface-400 outline-none focus:border-tertiary-200;
	}
